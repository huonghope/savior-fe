        ...
        <CardBody className="p-4">
          <div>
            ...
            <TabContent activeTab={activeTab} className="p-3 border border-top-0 rounded-bottom text-muted">
              ...
              <TabPane tabId="2">
                <p className="mb-0">
                                                            Food truck fixie locavore, accusamus mcsweeney marfa nulla
              ...
              <TabPane tabId="3">
                <p className="mb-0">
                                                            ...
                                                            sold out mcsweeney organic lomo retro fanny pack lo-fi
          ...
          <div className="mt-5">
            ...
            <TabContent activeTab={basicActiveTab} className="tab-content p-3 text-muted">
              ...
              <TabPane tabId="3">
                <p className="mb-0">
                                                            Etsy mixtape wayfarers, ethical wes anderson tofu before they
                                                            sold out mcsweeneys organic lomo retro fanny pack lo-fi
                                                            farm-to-table readymade. Messenger bag gentrify pitchfork
                                                            tattooed craft beer, iphone skateboard locavore carles etsy
