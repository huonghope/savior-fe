      ...
      <Card className="card mt-4" id="buttons">
        ...
        <CardBody className="p-4">
          ...
          <div className="mt-5">
            ...
            <p className="text-muted">Replace the default modifier classes with the
              <code className="highlighter-rouge">           .btn-outline-*</code> ones to remove all background images and colors on any button.</p>
            <div className="d-flex flex-wrap gap-2">
