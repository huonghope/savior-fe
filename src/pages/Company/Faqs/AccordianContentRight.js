      ...
      <div className="accordion-item mt-4 border-0">
        ...
        <Collapse isOpen={isCollapseFourth} id="general-four">
          <div className="accordion-body">
                        Just as the name suggests, a FAQ page is all about simple questions and answers.
                        Gather common questions your customers have asked from your support team and include them in the FAQ, Use categories to organize questions related to specific topics.
          </div>
        </Collapse>
      </div>
