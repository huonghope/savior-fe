      ...
      {jobVacancyPost2.map((jobVacancyList2Details, key) => (
        ...
        >
          <div className="p-4">
            <Row>
              <Col lg={1}>
                <Link to="/companydetails"><img src={jobVacancyList2Details.companyImg} alt="" className="img-fluid rounded-3" /></Link>
              </Col>
              <Col lg={10}>
                <div className="mt-3 mt-lg-0">
                  <h5 className="fs-17 mb-1">
                    <Link to="/jobdetails" className="text-dark">{jobVacancyList2Details.jobDescription}</Link>
                    <small className="text-muted fw-normal">({jobVacancyList2Details.experience})</small></h5>
                  <ul className="list-inline mb-0">
                    <li className="list-inline-item">
                      <p className="text-muted fs-14 mb-0">{jobVacancyList2Details.companyName}</p>
                    </li>
                    <li className="list-inline-item">
                      <p className="text-muted fs-14 mb-0"><i className="mdi mdi-map-marker"></i>{jobVacancyList2Details.location}</p>
                    </li>
                    <li className="list-inline-item">
                      <p className="text-muted fs-14 mb-0"><i className="uil uil-wallet"></i> {jobVacancyList2Details.salary}</p>
                    </li>
                  </ul>
                  <div className="mt-2">
                    <span
                    ...
                    {(jobVacancyList2Details.badges || []).map((badgeInner, key) => (
                      <span
