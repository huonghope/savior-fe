  ...
  return (
    <React.Fragment>
              ...
              <Col lg={10}>
                <div className="mt-3 mt-lg-0">
                  <h5 className="fs-17 mb-1">
                    <Link to="/jobdetails" className="text-dark">{jobVacancyPostDetails.jobDescription}</Link>
                    <small className="text-muted fw-normal">({jobVacancyPostDetails.experience})</small></h5>
      ...
      <div className="text-center mt-4">
        <Link to="/joblist" className="primary-link form-text">View More <i className="mdi mdi-arrow-right"></i></Link>
      </div>
