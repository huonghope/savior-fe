                  ...
                  <Col lg={2} className="align-self-center">
                    <ul className="list-inline mt-3 mb-0">
                      <li className="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="View More">
                        <Link to="/jobdetails" className="avatar-sm bg-soft-success d-inline-block text-center rounded-circle fs-18">
          ...
          <Modal isOpen={modal} toggle={openModal} centered>
            ...
            <ModalBody>
              <div>
                ...
                <p className="text-muted"> Your jobs post will be permenently removed and you wont be able to see them again, including the once you are shared with your friends.</p>
              </div>
            </ModalBody>
