              ...
              <TabPane tabId="1">
                <div>
                  ...
                  <p className="text-muted mt-4">
                                        ...
                                        scores for <b>International University</b>. Bachelor
                                        degree in communications.
                  </p>
                  <p className="text-muted">
                                        It describes the candidate relevant experience,
                ...
                <div className="candidate-education-details mt-4">
                  ...
                  <div className="candidate-education-content mt-4 d-flex">
                    ...
                    <div className="ms-4">
                      ...
                      <p className="text-muted">There are many variations of passages of available, but the majority alteration in some form.
                      As a highly skilled and successfull product development and design specialist with more than 4 Years of My experience.</p>
                    </div>
                  </div>
                  <div className="candidate-education-content mt-4 d-flex">
                    ...
                    <div className="ms-4">
                      ...
                      <p className="text-muted mb-0">There are many variations of passages of available, but the majority alteration in some form.
                      As a highly skilled and successfull product development and design specialist with more than 4 Years of My experience.</p>
                    </div>
                  </div>
                </div>
                      ...
                      <Col lg={12}>
                        <div className="mb-3">
                          ...
                          <textarea className="form-control"
                            rows="5">Developer with over 5 years experience working in both the public and private sectors. Diplomatic, personable, and adept at managing sensitive situations.
                            Highly organized, self-motivated, and proficient with computers.
                            Looking to boost students’ satisfactions scores for International University. Bachelor degree in communications.</textarea>
                        </div>
                      </Col>
